...
- **Google Calendar** (`CalendarApp`): se nel progetto c'è anche il file
  ...
  dallo script ha il fuso orario dello script (se non è quello italiano,
  Europe/Rome, le funzioni che mettono o cambiano gli eventi si fermano
  prima di toccare il calendario); a quello del docente che ne
