...
rimette nell'installer, firma anche l'installer e pubblica il rilascio. Le
tre cose da impostare nel repository sono documentate in testa al workflow
(token e identificativi di SignPath).
