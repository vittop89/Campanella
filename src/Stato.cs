...
namespace Campanella
{
    ...
    class Stato
    {
        ...
        /// dati nel Drive.
        /// Formato 3 (1.6.0): "unoQualsiasi" dentro le regole (le regole delle
        /// classi: l'oggetto oppure gli studenti); la 1.5.3 riscrivendo i file
        /// lo perderebbe, e la regola di una classe vorrebbe senza dirlo
